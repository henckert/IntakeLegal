...
Environment Variables (add via Render Dashboard):
  - NODE_ENV=production
  - PORT=10000
  - OPENAI_API_KEY=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
  - DATABASE_URL=postgresql://neondb_owner:npg_durK8Bbt0CNY@ep-shiny-scene-abnixujn-pooler.eu-west-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require
...
Environment Variables (add via Vercel Dashboard):
  ...
  - OPENAI_API_KEY=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 (optional)
```
...
```
postgresql://neondb_owner:npg_durK8Bbt0CNY@ep-shiny-scene-abnixujn-pooler.eu-west-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require
```
